...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NodesManage = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PropertiesPanel = __webpack_require__(4);
	...
	var _mousetrap = __webpack_require__(14);
	...
	var NodesManage = function () {
	    ...
	    _createClass(NodesManage, [{
	        ...
	        value: function makeDraggable() {
	            ...
	            var nodesObjects = this.getAllNodes().map(function (node) {
	                return node.getObject3D();
	            });
	        ...
	        value: function removeNode(node) {
	            ...
	            var needChangeFocus = this.scene.focusedNode == node;
	            var srcs = node.srcs;
	            var rfrs = node.rfrs;
	            ...
	            if (needChangeFocus) {
	                var avaliableSrcs = srcs.filter(function (src) {
	                    return src.from instanceof _Node2.default;
	                });
	                var avaliableRfrs = rfrs.filter(function (rfr) {
	                    return rfr.to instanceof _Node2.default;
	                });
	                var focusTarget = null;
	                if (avaliableSrcs.length > 0) focusTarget = avaliableSrcs[0].from;else if (avaliableRfrs.length > 0) focusTarget = avaliableRfrs[0].to;else {
	            ...
	            try {
	                for (var _iterator = this.getAllNodes()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var n = _step.value;
	        ...
	        value: function storeNodeManageStatus(forceValue) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropertiesPanel = function () {
	    ...
	    _createClass(PropertiesPanel, [{
	        ...
	        value: function getPropertyObject(prop) {
	            var _iteratorNormalCompletion = true;
	            var _didIteratorError = false;
	            var _iteratorError = undefined;
	            ...
	            try {
	                for (var _iterator = this.panelProperties[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    if (property.options.name === prop) return property;
	                }
	            } catch (err) {
	                _didIteratorError = true;
	                _iteratorError = err;
	        ...
	        value: function resetPanel() {
	            ...
	            try {
	                for (var _iterator2 = this.panelProperties[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                    var panelProperty = _step2.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GLText = __webpack_require__(12);
	    ...
	    _createClass(Node, [{
	        ...
	        value: function setInitialProps(props) {
	            for (var prop in props) {
	                this.setProp(prop, props[prop], false);
	            }
	        }
	    }, {
	        key: 'setProp',
	        ...
	        key: 'fixPosition',
	        value: function fixPosition(obj) {
	            obj = Object.assign({}, this.position, obj);
	        ...
	        value: function destroy() {
	            ...
	            window.bindEvent.removeEventListener(this.mesh, 'click', function (e) {
	                _this2.onClick(e);
	            }, false);
	            window.bindEvent.removeEventListener(this.mesh, 'dblclick', function (e) {
	                _this2.onDoubleClick(e);
	            }, false);
	            window.bindEvent.removeEventListener(this.mesh, 'mousedown', function (e) {
	                _this2.onMouseDown(e);
	            }, false);
	            window.bindEvent.removeEventListener(this.mesh, 'mouseup', function (e) {
	                _this2.onMouseUp(e);
	            }, false);
	            window.bindEvent.removeEventListener(this.mesh, 'mouseover', function (e) {
	                _this2.onMouseOver(e);
	            }, false);
	            window.bindEvent.removeEventListener(this.mesh, 'mouseout', function (e) {
	                _this2.onMouseOut(e);
	            }, false);
	            this.geometry = null;
	            this.material = null;
	        ...
	        value: function onDragging() {
	            var _getObject3D$position = this.getObject3D().position,
	                x = _getObject3D$position.x,
	                y = _getObject3D$position.y,
	                z = _getObject3D$position.z;
	        ...
	        value: function setPropertyX(value) {
	            var lookAtMe = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
	...
	var Arrow = function () {
	    ...
	    _createClass(Arrow, [{
	        ...
	        value: function checkVisibility() {
	            var fromVisiblity = this.from.visible == undefined || this.from.visible == true;
	            var toVisiblity = this.to.visible == undefined || this.to.visible == true;
	            if (fromVisiblity && toVisiblity) this.arrow.visible = true;else this.arrow.visible = false;
	        }
	    }, {
	        key: 'getCone',
